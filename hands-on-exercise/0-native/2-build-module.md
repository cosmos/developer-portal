...
```protobuf [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/proto/alice/checkers/module/v1/module.proto]
syntax = "proto3";
...
```sh [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/scripts/protocgen.sh]
#!/usr/bin/env bash
...
```yaml [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/proto/buf.gen.gogo.yaml]
version: v1
plugins:
  - name: gocosmos
    out: ..
...
```yaml [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/proto/buf.gen.pulsar.yaml]
version: v1
managed:
  enabled: true
  go_package_prefix:
...
```yaml [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/proto/buf.lock]
...
```yaml [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/proto/buf.yaml]
version: v1
deps:
...
```lang-makefile [https://github.com/b9lab/checkers-minimal/blob/06143c1ef03f0ec0a9fc1926114ef968c7e90246/Makefile]
#!/usr/bin/make -f
...
```diff-sh [https://github.com/b9lab/checkers-minimal/commit/743c344bdc4f1747ec2de98870e36c3ab152a4f3]
-   cp -r github.com/alice/checkers/* ./
+   # cp -r github.com/alice/checkers/* ./
```
...
This creates a new [`api/module/v1/module.pulsar.go`](https://github.com/b9lab/checkers-minimal/blob/5a7dae559caed819aa5d4831353aaa81e86dcb75/api/module/v1/module.pulsar.go) file and updates your `go.mod`. It also creates a new `go.sum`.
...
```protobuf [https://github.com/b9lab/checkers-minimal/blob/28356a1b4062d580225fbda3401e0f3082e90869/proto/alice/checkers/v1/types.proto]
syntax = "proto3";
...
```diff [https://github.com/b9lab/checkers-minimal/blob/8e94afc715516f350bf3e39679d2eec0c372ee37/go.mod#L8]
...
```go [https://github.com/b9lab/checkers-minimal/blob/063e5756bb8d35bdb00437a93d0a422a5f3767c7/codec.go]
package checkers
...
```go [https://github.com/b9lab/checkers-minimal/blob/063e5756bb8d35bdb00437a93d0a422a5f3767c7/params.go]
package checkers
...
```go [https://github.com/b9lab/checkers-minimal/blob/063e5756bb8d35bdb00437a93d0a422a5f3767c7/genesis.go]
package checkers
...
```go [https://github.com/b9lab/checkers-minimal/blob/063e5756bb8d35bdb00437a93d0a422a5f3767c7/keys.go]
package checkers
...
```go [https://github.com/b9lab/checkers-minimal/blob/f8935bce9d42a8594295c69d2aea6940d6f7c756/keeper/keeper.go]
package keeper
...
```go [https://github.com/b9lab/checkers-minimal/blob/f8935bce9d42a8594295c69d2aea6940d6f7c756/keeper/genesis.go]
package keeper
...
```go [https://github.com/b9lab/checkers-minimal/blob/4bd2a4b3f56c164cf40f23b4c881068bc29c6309/module/module.go]
package module
...
```go [https://github.com/b9lab/checkers-minimal/blob/4bd2a4b3f56c164cf40f23b4c881068bc29c6309/module/depinject.go]
package module
...
```go [https://github.com/b9lab/checkers-minimal/blob/4bd2a4b3f56c164cf40f23b4c881068bc29c6309/module/autocli.go]
package module
