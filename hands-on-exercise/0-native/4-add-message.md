...
```protobuf [https://github.com/b9lab/checkers-minimal/blob/create-game/proto/alice/checkers/v1/tx.proto]
syntax = "proto3";
...
In the new [`tx.pg.go`](https://github.com/b9lab/checkers-minimal/blob/create-game/tx.pb.go), you can find [`type MsgCreateGame struct`](https://github.com/b9lab/checkers-minimal/blob/create-game/tx.pb.go#L34-L40) and [`type MsgServer interface`](https://github.com/b9lab/checkers-minimal/blob/create-game/tx.pb.go#L205-L208). Now you can use them closer to the keeper.
...
```go [https://github.com/b9lab/checkers-minimal/blob/create-game/keeper/msg_server.go]
package keeper
...
```diff-go [https://github.com/b9lab/checkers-minimal/blob/create-game/codec.go#L5-L14]
    package checkers
...
```diff-go [https://github.com/b9lab/checkers-minimal/blob/create-game/module/module.go#L71]
    ...
...
```diff-go [https://github.com/b9lab/checkers-minimal/blob/create-game/module/autocli.go#L12-L26]
    import (
