...
You can skip ahead and see how to integrate [foreign tokens](./10-wager-denom.md) via the use of IBC, or take a look at the [next section](./8-gas-meter.md) to prevent spam and reward validators proportional to their effort in your checkers blockchain.-->
