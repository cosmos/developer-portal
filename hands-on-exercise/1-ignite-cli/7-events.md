...
* You understand the concepts of [events](/academy/2-cosmos-concepts/10-events.md).
* Go is installed.
...
![Live values of event in debug mode](/hands-on-exercise/1-ignite-cli/images/go_test_debug_event_attributes.png)
