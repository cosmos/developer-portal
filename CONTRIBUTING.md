...
* To set up the portal locally, please follow the [Local setup and build](TECHNICAL-SETUP.md#local-setup-and-build) guide in the [TECHNICAL SETUP](TECHNICAL-SETUP.md) document. You might also want to read the [further environment tips](TECHNICAL-SETUP.md#Environments) in that file.
